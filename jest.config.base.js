...
const config = {
  ...
  transformIgnorePatterns: [
    `node_modules/(?!(?:.pnpm/)?(abortable-rx|@sourcegraph/comlink|monaco-editor|monaco-yaml|marked|date-fns|react-sticky-box))`
  ],
  ...
  // By default, don't clutter `pnpm test --watch` output with the full coverage table. To see it, use the
