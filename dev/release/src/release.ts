                        ...
                        ...prBodyAndDraftState(
                            ((): string[] => {
                                ...
                                items.push(
                                    ...
                                    'Run `pnpm release release:finalize` to generate the tags required. CI will not pass until this command is run.',
...
Batch change: ${batchChangeURL}`,
    ...
    },
    {
        ...
        // Example: pnpm release release:add-to-batch-change sourcegraph/about 1797
...
${patchRequestIssues.map(issue => `* #${issue.number}`).join('\n')}`
    ...
    },
    {
        ...
        // Example: pnpm release _test:batchchange-create-from-changes "$(cat ./.secrets/test-batch-change-import.json)"
